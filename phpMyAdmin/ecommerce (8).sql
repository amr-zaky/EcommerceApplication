...
(1, 'admin@app.com', '$2y$10$XRJ8He69z9giy87.h8t92.mULkbc5FSXQeBNhQw/9CLRrGWinzlH.', 1, 'suberAdmin', 1, NULL, '2020-04-27 11:05:34', '2020-05-10 10:59:42');
...
(1, 'uploads/ads/first.mp4', 'video', '2020-05-03', '2020-05-24', 1, 'product', 1, 1, '2020-05-17 10:19:26', 1, 1),
(2, 'uploads/ads/tt1.jpg', 'image', '2020-05-03', '2020-05-24', 3, 'product', 3, 1, '2020-05-17 10:19:27', 1, 1),
(3, 'uploads/ads/w2.jpg', 'image', '2020-05-03', '2020-05-24', 8, 'product', 2, 1, '2020-05-17 08:57:26', 1, 1);
...
INSERT INTO `complaints` (`id`, `userId`, `content`, `is_readed`, `created`, `updated`) VALUES
(1, 1, 'erorr', 0, '2020-05-11 10:56:04', '2020-05-11 10:56:04'),
(2, 1, '\'select * from admins\'', 0, '2020-05-11 10:56:25', '2020-05-11 10:56:25'),
(3, NULL, '\'select * from admins\'', 0, '2020-05-11 11:05:59', '2020-05-11 11:23:17');
...
(1, 'Clothing', 'ملابس', 'uploads/category/Clothing.png', 1, 1, '2020-05-10 12:29:12', 1, 1),
(2, 'Electronic', 'اجهزه اليكترونيه', 'uploads/category/Electronic.jpg', 2, 1, '2020-05-10 12:09:06', 1, 1),
(3, 'furnitures', 'اثاثe', 'uploads/category/furniture.jpg', 3, 1, '2020-05-11 08:02:12', 1, 1);
...
INSERT INTO `offers` (`id`, `productId`, `type`, `discountAmount`, `priceBefore`, `priceAfter`, `isActive`, `viewOrder`, `modified`, `createdBy`, `modifiedBy`) VALUES
(1, 7, 'amount', 100, 1200, 1100, 1, 1, '2020-05-17 12:29:09', 1, 1),
(2, 2, 'amount', 10, 250, 240, 1, 3, '2020-05-17 12:33:39', 1, 1);
...
CREATE TABLE `order_details` (
  ...
  `additional_option` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created` timestamp GENERATED ALWAYS AS (current_timestamp()) VIRTUAL,
  `modified` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'shoes', 'A shoe is an item of footwear intended to protect and comfort the human foot. Shoes are also used as an item of decoration and fashion', 'حذاء جلد', 'يستغرق الاعتياد على حذاء جديد وقتًا طويلًا حيث يحتاج الجلد إلى فترة طويلة ليصبح بالطراوة المرغوبة. عادةً ما تصبح الجلود الرقيقة', 3, 150.00, 2, 30, 0, 1, 1, 0, '2020-05-12 08:24:04', 1, 1),
...
(10, 'main', 'wergverr', 'تست', 'هخبثرفعهفع', 3, 20.00, 2, 25, 0, 1, 1, 0, '2020-05-17 08:38:19', 1, 1),
(11, 'test', 'efonwe', 'test', 'eoinfweurjr', 3, 150.00, 2, 10, 0, 1, 0, 1, '2020-05-17 10:35:29', 1, NULL);
...
(11, 10, 'uploads/product/15893606971805327791.jpg', 1, '2020-05-13 09:08:32', 1, NULL),
(12, 10, 'uploads/product/15893606972054580971.jpg', NULL, '2020-05-13 09:04:58', 1, NULL),
(13, 10, 'uploads/product/1589360698983466006.jpg', NULL, '2020-05-13 09:04:58', 1, NULL),
(16, 11, 'uploads/product/15897041501807446981.jpg', NULL, '2020-05-17 08:29:11', 1, NULL),
(17, 11, 'uploads/product/1589704151951523297.jpg', NULL, '2020-05-17 08:29:11', 1, NULL);
...
(1, 'Size', 'مقاس', '2020-05-12 11:34:21', 1, 1),
...
INSERT INTO `product_type_units` (`id`, `productId`, `value`, `typeId`, `modified`, `createdBy`, `modifiedBy`) VALUES
(1, 2, '42', 2, '2020-05-13 08:31:40', 1, 1),
(2, 1, '39', 1, '2020-05-12 11:34:37', 1, 1),
(3, 3, 'L', 1, '2020-05-12 11:35:00', 1, 1),
(5, 1, '40', 1, '2020-05-12 11:35:54', 1, 1),
(6, 1, '25', 1, '2020-05-13 08:27:49', 1, NULL),
(8, 7, 'intel c i5 lenovo', 2, '2020-05-13 08:36:13', 1, NULL);
...
INSERT INTO `rate` (`id`, `rate`, `comment`, `userId`, `productId`, `modified`) VALUES
(1, 3, 'this is good App', NULL, 1, '2020-05-11 11:21:25');
...
CREATE TABLE `sub_categories` (
  ...
  `nameAr` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mainCategoryId` bigint(20) UNSIGNED DEFAULT NULL,
  `isActive` tinyint(4) DEFAULT 1,
  `displayOrder` int(11) DEFAULT NULL,
  `created` timestamp GENERATED ALWAYS AS (current_timestamp()) VIRTUAL,
  `modified` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
(1, 'T-shirt', 'تيشرت', 'uploads/category/t-shirt.png', 1, 1, 1, '2020-05-13 09:22:31', 1, 1),
...
(5, 'printers', 'طبعات', 'uploads/category/printers.png', 2, 1, 12, '2020-05-11 08:22:16', 1, 1),
...
INSERT INTO `suppliers` (`id`, `name`, `title`, `nameAr`, `titleAr`, `image`, `phone`, `modified`, `createdBy`, `modifiedBy`) VALUES
(1, 'B-tech', 'Electronic store', 'بى -تك', 'متجر الكترونات', 'uploads/product/b-tech.jpg', '012364894518', '2020-05-11 09:42:04', 1, 1),
(2, 'Active', 'Clothing store', 'اكتف', 'متجر ملابس', 'uploads/product/Active.jpg', '0123894518', '2020-05-11 09:41:50', 1, 1);
...
ALTER TABLE `offers`
  ...
  ADD KEY `offers_ibfk_1` (`createdBy`);
...
ALTER TABLE `products`
  ...
  ADD KEY `products_ibfk_1` (`createdBy`);
...
ALTER TABLE `product_keywords`
  ...
  ADD KEY `product_keywords_ibfk_1` (`createdBy`);
...
ALTER TABLE `product_type`
  ...
  ADD KEY `product_type_ibfk_1` (`createdBy`);
...
ALTER TABLE `sub_categories`
  ...
  ADD KEY `sub_categories_ibfk_1` (`createdBy`);
...
ALTER TABLE `suppliers`
  ...
  ADD KEY `suppliers_ibfk_1` (`createdBy`);
...
--
ALTER TABLE `complaints`
  ADD CONSTRAINT `complaint_user_id` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `offers`
  ...
  ADD CONSTRAINT `offersModifiedBy` FOREIGN KEY (`modifiedBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `offers_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ...
  ADD CONSTRAINT `supplier_id` FOREIGN KEY (`supplierId`) REFERENCES `suppliers` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `product_images`
  ...
  ADD CONSTRAINT `product_images_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `product_keywords`
  ...
  ADD CONSTRAINT `product_keywords_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `product_type`
  ...
  ADD CONSTRAINT `product_type_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `product_type_units`
  ...
  ADD CONSTRAINT `product_type_units_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
ALTER TABLE `rate`
  ...
  ADD CONSTRAINT `rate_user_id` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `sub_categories`
  ...
  ADD CONSTRAINT `sub_categories_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `suppliers`
--
ALTER TABLE `suppliers`
  ADD CONSTRAINT `suppliers_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `admins` (`id`);
